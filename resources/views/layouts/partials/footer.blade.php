<footer class="border-t border-emerald-900/10 bg-emerald-950">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 gap-10 md:grid-cols-12">
      ...
      <div class="md:col-span-4">
        <p class="text-lg font-semibold text-white">ASDM Associates</p>
        <p class="mt-2 text-sm leading-relaxed text-white/70">
          Solusi hukum yang tegas, profesional, dan terpercaya.
        </p>
      ...
      <div class="md:col-span-4">
        ...
        <div class="mt-3 space-y-2 text-sm text-white/70">
          <a href="mailto:info@asdmassociates.com"
             class="group flex items-center gap-2 hover:text-white transition">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0 text-white/60 group-hover:text-white"
      ...
      {{-- KOLOM ALAMAT --}}
<div class="md:col-span-4">
  <p class="text-sm font-semibold text-white">Alamat</p>

  {{-- HEAD OFFICE --}}
  <p class="mt-3 text-xs font-semibold text-white/80 tracking-wide">
    Head Office
  </p>
  ...
  <div class="mt-1 flex items-start gap-2 text-sm text-white/70">
    ...
    {{-- BOTTOM --}}
    <div class="mt-10 border-t border-emerald-900/10 pt-6 text-center">
      <p class="text-sm text-slate-500">
        © {{ date('Y') }} ASDM Associates. All rights reserved.
      </p>
    </div>
