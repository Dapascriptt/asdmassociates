...
<body class="h-full bg-page text-slate-800 antialiased selection:bg-emerald-200/60 selection:text-emerald-950">
    ...
    <div class="fixed bottom-5 right-5 z-50 flex flex-col items-center gap-3">
      ...
      {{-- Instagram (di bawah WA) --}}
      <a href="https://instagram.com/saridamayanti_associates" target="_blank" rel="noopener"
         class="inline-flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 text-white shadow-lg shadow-rose-400/40 hover:scale-105 transition"
